...
# Modified by Shroom 
#
# NOTE! ASSUMES YOU ARE 100+ CIRCLE AND CAN TAKE WAYS FROM ANYWHERE
# DOES NOT TRY TO TRAVEL TO SHARD FIRST 
...
put #echo >Log *** ASTRAL TRAVEL START - Zone:$zoneid
pause 0.1
...
put #echo >Log *** ASTRAL TRAVEL ARRIVED AT %destination
echo *** Arrived at %1 ***
put #mapper reset
exit
